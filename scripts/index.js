...
const popupPhotoTitle = document.querySelector('.popup__caption'); // => Card =>_createNewCard
const popupPhotoImg = document.querySelector('.popup__photo'); // => Card =>_createNewCard
